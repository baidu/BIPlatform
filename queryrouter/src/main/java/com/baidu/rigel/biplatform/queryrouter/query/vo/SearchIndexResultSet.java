...
import com.baidu.rigel.biplatform.queryrouter.query.exception.NotSupportedDateFormatException;
import com.baidu.rigel.biplatform.queryrouter.query.service.utils.DateFormatType;
import com.baidu.rigel.biplatform.queryrouter.query.service.utils.StringTools;

/**
 * 类SearchIndexResultSet.java的实现描述：TODO 类实现描述
 * 
 * @author luowenlei 2015年12月9日 下午8:31:36
 */
public class SearchIndexResultSet implements TesseractResultSet<SearchIndexResultRecord> {
     ...
     * 
     * @see
     * com.baidu.rigel.biplatform.tesseract.resultset.TesseractResultSet#next()
     */
    @Override
     ...
     * 
     * @see
     * com.baidu.rigel.biplatform.tesseract.resultset.TesseractResultSet#close()
     */
    @Override
    public void close() {
     ...
     *            待格式化的字段
     * @return Date
     * @throws NotSupportedDateFormatException
     *             可以抛出异常
     ...
     * 
     * @see
     * com.baidu.rigel.biplatform.tesseract.resultset.TesseractResultSet#getString
     * (int)
     */
    @Override
     ...
     * 
     * @see
     * com.baidu.rigel.biplatform.tesseract.resultset.TesseractResultSet#getInt
     * (int)
     */
    @Override
     ...
     * 
     * @see
     * com.baidu.rigel.biplatform.tesseract.resultset.TesseractResultSet#getLong
     * (int)
     */
    @Override
     ...
     * 
     * @see
     * com.baidu.rigel.biplatform.tesseract.resultset.TesseractResultSet#getDate
     * (int)
     */
    @Override
    public Date getDate(int columnIndex) throws NoSuchFieldException,
            NotSupportedDateFormatException, ParseException {
        Object field = this.currRecord.getField(columnIndex);
     ...
     * (non-Javadoc)
     * 
     * @see com.baidu.rigel.biplatform.tesseract.resultset.TesseractResultSet#
     * getBigDecimal(int)
     */
    @Override
     ...
     * 
     * @see
     * com.baidu.rigel.biplatform.tesseract.resultset.TesseractResultSet#size()
     */
    @Override
    public int size() {
        if (this.dataList != null) {
