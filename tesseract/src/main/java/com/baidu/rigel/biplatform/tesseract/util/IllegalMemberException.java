...
public class IllegalMemberException extends RuntimeException {
     ...
     * serialVersionUID
     */
    private static final long serialVersionUID = 2942348015902278221L;
     ...
     * 构造函数
     */
    public IllegalMemberException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
