define(['template'], function (template) {
    function anonymous($data,$filename
        ...
        'use strict';
        $data=$data||{};
        var $utils=template.utils,$helpers=$utils.$helpers,$each=$utils.$each,taskMgrList=$data.taskMgrList,$item=$data.$item,index=$data.index,$escape=$utils.$escape,$out='';$out+='<div class="fix-report-task-mgr-list">\n    <table cellspacing="0">\n        <thead>\n            <tr>\n                <th class="list-index">任务名称</th>\n                <th class="list-name">运行状态</th>\n                <th class="list-btns">操作</th>\n                <th class="list-url">url地址</th>\n            </tr>\n        </thead>\n        <tbody>\n        ';
